...
class DepartementVideoType extends AbstractType
{
...
//                        'data' => $sites,
        ...
        $builder
            ...
            ->add('traductions', CollectionType::class, array(
                'entry_type' => DepartementVideoTraductionType::class,
                'allow_add' => true,
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Mondofute\Bundle\GeographieBundle\Entity\DepartementVideo'
        ));
    }
    ...
    {
        return 'mondofute_bundle_geographiebundle_departementvideo';
    }
