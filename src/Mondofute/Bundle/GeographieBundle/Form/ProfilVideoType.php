...
class ProfilVideoType extends AbstractType
{
...
//                        'data' => $sites,
        ...
        $builder
            ...
            ->add('traductions', CollectionType::class, array(
                'entry_type' => ProfilVideoTraductionType::class,
                'allow_add' => true,
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Mondofute\Bundle\GeographieBundle\Entity\ProfilVideo'
        ));
    }
    ...
    {
        return 'mondofute_bundle_geographiebundle_profilvideo';
    }
