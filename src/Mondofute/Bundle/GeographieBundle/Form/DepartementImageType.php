...
class DepartementImageType extends AbstractType
{
    /**
...
//                        'data' => $sites,
        ...
        $builder
            ...
            ->add('traductions', CollectionType::class, array(
                'entry_type' => DepartementImageTraductionType::class,
                'allow_add' => true,
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Mondofute\Bundle\GeographieBundle\Entity\DepartementImage',
        ));
    }
