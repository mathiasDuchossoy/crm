...
class ZoneTouristiquePhotoType extends AbstractType
{
    /**
            ...
            if ($data && null !== $data->getId()) {
                $form
                    ->add('photo', 'sonata_media_type', array(
                        ...
                        'context' => 'zone_touristique_photo_crm',
                        'required' => false,
                        'label' => 'photo',
                    ))
...
//                        'data' => $sites,
        ...
        $builder
            ...
            ->add('traductions', CollectionType::class, array(
                'entry_type' => ZoneTouristiquePhotoTraductionType::class,
                'allow_add' => true,
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Mondofute\Bundle\GeographieBundle\Entity\ZoneTouristiquePhoto',
        ));
    }
