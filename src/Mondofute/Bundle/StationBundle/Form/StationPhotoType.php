...
class StationPhotoType extends AbstractType
{
    /**
...
//                        'data' => $sites,
        ...
        $builder
            ...
            ->add('traductions', CollectionType::class, array(
                'entry_type' => StationVisuelTraductionType::class,
                'allow_add' => true,
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Mondofute\Bundle\StationBundle\Entity\StationPhoto',
            'model_class' => 'Mondofute\Bundle\StationBundle\Entity\StationPhoto',
        ));
    }
    ...
    public function finishView(FormView $view, FormInterface $form, array $options)
    {
        ...
        $view->children['visuel']->children['binaryContent']->vars['attr'] = array("accept" => "image/x-png, image/gif, image/jpeg");
    }
