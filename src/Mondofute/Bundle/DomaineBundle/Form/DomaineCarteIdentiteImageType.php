            ...
            if ($data && null !== $data->getId()) {
                $form
                    ->add('image', 'sonata_media_type', array(
                        ...
                        'context' => 'domaine_carte_identite_image_crm',
                        'required' => false,
                        'label' => 'image',
                    ))
...
//                        'data' => $sites,
        ...
        $builder
            ...
            ->add('traductions', CollectionType::class, array(
                'entry_type' => DomaineCarteIdentiteImageTraductionType::class,
                'allow_add' => true,
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Mondofute\Bundle\DomaineBundle\Entity\DomaineCarteIdentiteImage',
        ));
    }
