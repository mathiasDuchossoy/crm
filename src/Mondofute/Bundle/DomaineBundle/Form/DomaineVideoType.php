...
class DomaineVideoType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
...
//                        'data' => $sites,
        ...
        $builder
            ...
            ->add('traductions', CollectionType::class, array(
                'entry_type' => DomaineVideoTraductionType::class,
                'allow_add' => true,
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Mondofute\Bundle\DomaineBundle\Entity\DomaineVideo'
        ));
    }
    ...
    {
        return 'mondofute_bundle_domainebundle_domainevideo';
    }
