...
class DomaineCarteIdentitePhotoType extends AbstractType
{
    /**
            ...
            if ($data && null !== $data->getId()) {
                $form
                    ->add('photo', 'sonata_media_type', array(
                        ...
                        'context' => 'domaine_carte_identite_photo_crm',
                        'required' => false,
                        'label' => 'photo',
                    ))
...
//                        'data' => $sites,
        ...
        $builder
            ...
            ->add('traductions', CollectionType::class, array(
                'entry_type' => DomaineCarteIdentitePhotoTraductionType::class,
                'allow_add' => true,
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Mondofute\Bundle\DomaineBundle\Entity\DomaineCarteIdentitePhoto',
        ));
    }
