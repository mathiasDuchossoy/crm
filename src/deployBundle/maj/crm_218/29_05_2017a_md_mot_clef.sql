...
CREATE TABLE mot_clef_traduction_hebergement (mot_clef_traduction_id INT UNSIGNED NOT NULL, hebergement_id INT UNSIGNED NOT NULL, INDEX IDX_4DA9025D637A4045 (mot_clef_traduction_id), INDEX IDX_4DA9025D23BB0F66 (hebergement_id), PRIMARY KEY(mot_clef_traduction_id, hebergement_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
...
ALTER TABLE mot_clef_traduction_hebergement ADD CONSTRAINT FK_4DA9025D637A4045 FOREIGN KEY (mot_clef_traduction_id) REFERENCES mot_clef_traduction (id) ON DELETE CASCADE;
ALTER TABLE mot_clef_traduction_hebergement ADD CONSTRAINT FK_4DA9025D23BB0F66 FOREIGN KEY (hebergement_id) REFERENCES hebergement (id) ON DELETE CASCADE;
...
ALTER TABLE mot_clef_traduction_hebergement DROP FOREIGN KEY FK_4DA9025D23BB0F66;
ALTER TABLE mot_clef_traduction_hebergement DROP FOREIGN KEY FK_4DA9025D637A4045;
ALTER TABLE mot_clef_traduction_hebergement ADD classement SMALLINT NOT NULL;
