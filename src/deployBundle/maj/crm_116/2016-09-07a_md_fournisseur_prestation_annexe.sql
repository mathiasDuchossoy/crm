...
CREATE TABLE IF NOT EXISTS fournisseur_prestation_annexe (id INT UNSIGNED AUTO_INCREMENT NOT NULL, capacite_id INT UNSIGNED DEFAULT NULL, duree_sejour_id INT UNSIGNED DEFAULT NULL, fournisseur_id INT UNSIGNED DEFAULT NULL, type INT UNSIGNED NOT NULL, UNIQUE INDEX UNIQ_9AB97BB37C79189D (capacite_id), UNIQUE INDEX UNIQ_9AB97BB39CDD2F46 (duree_sejour_id), INDEX IDX_9AB97BB3670C757F (fournisseur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
