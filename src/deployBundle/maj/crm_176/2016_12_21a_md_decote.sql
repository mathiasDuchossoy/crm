...
CREATE TABLE decote_canal_decote (decote_id INT UNSIGNED NOT NULL, canal_decote_id INT UNSIGNED NOT NULL, INDEX IDX_A0F09FD4A5DBDC32 (decote_id), INDEX IDX_A0F09FD483A3A50D (canal_decote_id), PRIMARY KEY(decote_id, canal_decote_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
ALTER TABLE decote_canal_decote ADD CONSTRAINT FK_A0F09FD4A5DBDC32 FOREIGN KEY (decote_id) REFERENCES decote (id) ON DELETE CASCADE;
ALTER TABLE decote_canal_decote ADD CONSTRAINT FK_A0F09FD483A3A50D FOREIGN KEY (canal_decote_id) REFERENCES canal_decote (id) ON DELETE CASCADE;
